...
public:
    ...
    MatchResultAndStyle matchResultAndStyleForElement(Element&, const ResolutionContext&, RuleMatchingBehavior = RuleMatchingBehavior::MatchAllRules);
    MatchResultAndStyle matchResultAndStyleForCachedResult(Element&, const ResolutionContext&, CachedMatchResult&&);
